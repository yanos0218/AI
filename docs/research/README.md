...
규칙은 [../research.md](../research.md). **2026-09-13부터 새 조사는 이 폴더가 아니라 GitHub Issue에 `research` 라벨로 남긴다** — 파일·이슈 이중 기록을 피하기 위함. 아래는 그 이전 기록이며 새로 늘지 않는다. 본문에 녹아 있는 것은 그 문서를 가리킨다.
