...
- 저장소 v0.9.0(gh-throttle 실제 직렬화, 서브에이전트 재귀 생성 전역 차단, 훅 스크립트-감싸기 우회 보강 — Issue #71 인시던트 후속). CI(`lint.yml`) 초록.
  - 배포 현황은 [PROGRESS.md §0](PROGRESS.md#0-자산-현황--단계와-배포-상태) 표가 원본 — Windows는 v0.9.0, Mac·웹은 v0.6.0, Linux는 미반영.
