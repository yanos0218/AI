...
- 저장소 v0.7.0(SessionStart 훅·복합 명령 규칙·test-skill.sh 구조 검사 등), CI(`lint.yml`) 초록. 배포 현황은 [PROGRESS.md §0](PROGRESS.md#0-자산-현황--단계와-배포-상태) 표가 원본 — Windows는 v0.7.0, Mac·웹은 v0.6.0, Linux는 미반영.
