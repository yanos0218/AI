...
| 제안 | 판정 | 이유·갈 곳 |
| --- | --- | --- |
| Release: 릴리즈 전 `gh auth status` 확인, 없으면 멈추고 `gh auth login` 안내, **토큰을 채팅에 붙여넣으라고 하지 않는다** | **채택 → 승격됨(2026-09-09)** | 실제 사고(2026-09-09 OpenClaw). 전역 §7에 한 줄 + dev-release 0단계. [C-53](../../docs/PROGRESS.md#c-53) |
